...
var Skin = class {
  ...
  constructor(name) {
    ...
    __publicField(this, "color", new Color(0.99607843, 0.61960787, 0.30980393, 1));
    if (!name)
      throw new Error("name cannot be null.");
    this.name = name;
  }
...
var _ThreeJsTexture = class _ThreeJsTexture extends Texture2 {
...
__publicField(_ThreeJsTexture, "fist", true);
var ThreeJsTexture = _ThreeJsTexture;
...
var _SkeletonMesh = class _SkeletonMesh extends Object3D {
  constructor(skeletonDataOrConfiguration, materialCustomizer = () => {
  }) {
    super();
    __publicField(this, "tempPos", new Vector2());
    __publicField(this, "tempUv", new Vector2());
    __publicField(this, "tempLight", new Color());
    __publicField(this, "tempDark", new Color());
    __publicField(this, "skeleton");
    __publicField(this, "state");
    __publicField(this, "zOffset", 0.1);
    __publicField(this, "batches", new Array());
    __publicField(this, "materialFactory");
    __publicField(this, "nextBatchIndex", 0);
    __publicField(this, "clipper", new SkeletonClipping());
    __publicField(this, "vertexSize", 2 + 2 + 4);
    __publicField(this, "twoColorTint");
    __publicField(this, "vertices", Utils.newFloatArray(1024));
    __publicField(this, "tempColor", new Color());
    __publicField(this, "tempDarkColor", new Color());
    __publicField(this, "_castShadow", false);
    __publicField(this, "_receiveShadow", false);
    ...
    this.materialFactory = skeletonDataOrConfiguration.materialFactory ?? (() => new MeshBasicMaterial(_SkeletonMesh.DEFAULT_MATERIAL_PARAMETERS));
...
__publicField(_SkeletonMesh, "DEFAULT_MATERIAL_PARAMETERS", {
  side: DoubleSide,
  depthWrite: true,
  depthTest: true,
  transparent: true,
...
__publicField(_SkeletonMesh, "QUAD_TRIANGLES", [0, 1, 2, 2, 3, 0]);
__publicField(_SkeletonMesh, "VERTEX_SIZE", 2 + 2 + 4);
var SkeletonMesh = _SkeletonMesh;

// node_modules/@esotericsoftware/spine-threejs/dist/MeshBatcher.js
var _MeshBatcher = class _MeshBatcher extends Mesh {
  constructor(maxVertices = _MeshBatcher.MAX_VERTICES, materialFactory, twoColorTint = true) {
    super();
    __publicField(this, "materialFactory");
    __publicField(this, "twoColorTint");
    // private static VERTEX_SIZE = 9;
    __publicField(this, "vertexSize", 9);
    __publicField(this, "vertexBuffer");
    __publicField(this, "vertices");
    __publicField(this, "verticesLength", 0);
    __publicField(this, "indices");
    __publicField(this, "indicesLength", 0);
    __publicField(this, "materialGroups", []);
    this.materialFactory = materialFactory;
    this.twoColorTint = twoColorTint;
    if (maxVertices > _MeshBatcher.MAX_VERTICES)
...
__publicField(_MeshBatcher, "MAX_VERTICES", 10920);
