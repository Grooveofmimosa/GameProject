...
var spine = (() => {
  ...
  var _ThreeJsTexture = class extends Texture {
    texture;
  ...
  __publicField(ThreeJsTexture, "fist", true);
  ...
  __publicField(SkeletonMesh, "DEFAULT_MATERIAL_PARAMETERS", {
  ...
  __publicField(SkeletonMesh, "QUAD_TRIANGLES", [0, 1, 2, 2, 3, 0]);
  __publicField(SkeletonMesh, "VERTEX_SIZE", 2 + 2 + 4);
  ...
  var _MeshBatcher = class extends THREE3.Mesh {
    constructor(maxVertices = _MeshBatcher.MAX_VERTICES, materialFactory, twoColorTint = true) {
      ...
      let vertexBuffer = this.vertexBuffer = new THREE3.InterleavedBuffer(vertices, this.vertexSize);
